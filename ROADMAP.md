...
- [x] اتصال وب‌هوک‌های GitHub:
  - کامپایل و بیلد خودکار فایل `.phar` با زدن Git Tag یا ساخت Release در ریپازیتوری دولوپر.
- [x] موتور تزریق خودکار ویریون (Virion Injector):
  - تزریق خودکار کتابخانه‌های مشخص‌شده در فایل مانیفست به داخل فایل phar نهایی.
- [x] کانال‌های انتشار چندگانه (Stable, Beta, Dev).
- [x] کامیت و پوش تغییرات فاز ۵ به گیت‌هاب.

---

## 📌 فاز ۶: استقرار، ایمن‌سازی و بهره‌برداری (Production & Deployment)
- [x] پیکربندی داکر (`Dockerfile` و `docker-compose.yml`) برای استقرار ایزوله در لینوکس.
- [x] استقرار روی سرور لینوکس متصل به دامنه **`av-api.ir`**.
- [x] پیکربندی Nginx معکوس و تنظیم SSL دامنه.
- [x] راه‌اندازی ورکرها و صف‌های پس‌زمینه (Queues/Workers) برای پردازش‌های سنگین بیلد و تحلیل امنیتی.
- [x] مانیتورینگ، بک‌آپ خودکار و لاگین خطاها.
- [x] کامیت و پوش تغییرات فاز ۶ به گیت‌هاب.
