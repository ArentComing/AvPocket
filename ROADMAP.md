...
- [ ] راه‌اندازی ساختار اصلی پروژه و اسکلت‌بندی (Scaffolding).
- [ ] تنظیم فایل‌های محیطی (`.env.example` و پیکربندی اولیه).
- [ ] طراحی شمای دیتابیس و مایگریشن‌ها:
...
- [ ] احراز هویت و مدیریت نشست‌ها (Email/Password و آماده‌سازی OAuth گیت‌هاب).
- [ ] کامیت و پوش تغییرات فاز ۱ به گیت‌هاب.

---

## 📌 فاز ۲: موتور آپلود و اعتبارسنجی هوشمند پاکت‌ماین (Core MVP - Inspector)
- [ ] سیستم آپلود فایل‌های دارایی (`.phar`, `.zip`, `.mcworld`, `.geo.json`).
- [ ] توسعه **Plugin Inspector** اختصاصی PocketMine-MP:
...
- [ ] سیستم اسکن امنیتی اولیه کد (Anti-Backdoor Scanner):
  - شناسایی توابع مشکوک (`eval`, `shell_exec`, `system`, `base64_decode` پرخطر، وب‌هوک‌های مشکوک دیسکورد).
- [ ] اعتبارسنجی نسخه‌ها و ذخیره‌سازی امن فایل‌ها در استوریج.
- [ ] کامیت و پوش تغییرات فاز ۲ به گیت‌هاب.

---

## 📌 فاز ۳: ویترین مارکت و تجربه کاربری (Showcase & Community)
- [ ] طراحی و پیاده‌سازی صفحه اصلی (Catalog):
...
- [ ] صفحه اختصاصی نمایش محصول (Product Showcase):
...
- [ ] پروفایل عمومی توسعه‌دهندگان (نمایش دارایی‌ها، مدال‌ها، کل دانلودها، لینک‌های ارتباطی).
- [ ] کامیت و پوش تغییرات فاز ۳ به گیت‌هاب.

---

## 📌 فاز ۴: سیستم مالی، خرید و مارکت‌پلیس (Monetization & Marketplace)
- [ ] تفکیک دارایی‌های رایگان (Free/Open-Source) و ویژه (Premium).
- [ ] سیستم کیف پول کاربران (User Balance & Wallet).
- [ ] اتصال درگاه پرداخت آنلاین (شتابی / زرین‌پال یا درگاه‌های واسط متناسب با دامنه `.ir`).
- [ ] سیستم تسویه‌حساب فروشندگان و محاسبه کارمزد پلتفرم.
- [ ] وب‌سرویس اعتبارسنجی لایسنس (License Verification API):
  - چک کردن لایسنس هنگام راه‌اندازی پلاگین در سرورهای ماینکرافت خریدار.
- [ ] کامیت و پوش تغییرات فاز ۴ به گیت‌هاب.
